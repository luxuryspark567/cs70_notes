...
d -dimensional hypercube consists of a 0-subcube and 1-subcube

each of which is a d−1-dimensional hypercube with nodes labelled

0x or 1x with the additional edges (0x, 1x).
