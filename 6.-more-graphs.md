...
**Lemma:** Any graph with <mark style="color:$warning;">maximum degree</mark> $$d$$ can be $$d + 1$$ colored.
...
**Induction Hypothesis:** Every planar graph with vetices less than v, and more than 6 can be colored with six colors.
