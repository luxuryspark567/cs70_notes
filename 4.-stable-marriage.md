...
{% hint style="warning" %}
In the next slides, I can just tell you the proof, but the problem is how you come up with the proof. Now the answer is I dont know. So there are various ways to do this. When I tell you about the proof, it is necessarily vague. I will just show you how maybe someone would struggle with this.
{% endhint %}

Theorem: For all n ≥1, $$\sum_{i=1}^{n} \frac {1} {i^2} \leq 2$$. ($$S_n = \sum_{i=1}^{n} \frac {1} {i^2}$$)

* Base: $$P(1): 1 \leq 2$$.
* Hypothesis: $$\sum_{i=1}^{k} \frac {1} {i^2} \leq 2$$
* Ind Step:&#x20;
...
* Not the same statement, the Hypothesis need to be proved.
...
<mark style="color:$warning;">**Definition**</mark><mark style="color:$warning;">: A</mark> <mark style="color:$warning;"></mark><mark style="color:$warning;">**rogue couple**</mark> $$(b, g^∗)$$<mark style="color:$warning;">for a pairing</mark> $$S$$<mark style="color:$warning;">:</mark> $$b$$ <mark style="color:$warning;">and</mark> $$g^∗$$ <mark style="color:$warning;">prefer each other to their partners in</mark> $$S$$<mark style="color:$warning;">.</mark>
...
2. <mark style="color:blue;">Each girl</mark> <mark style="color:blue;"></mark><mark style="color:blue;">**rejects all but her favorite proposer**</mark> <mark style="color:blue;"></mark><mark style="color:blue;">(whom she puts on a string.)</mark>
3. <mark style="color:blue;">Rejected boy</mark> <mark style="color:blue;"></mark><mark style="color:blue;">**crosses rejecting girl off**</mark> <mark style="color:blue;"></mark><mark style="color:blue;">his list.</mark>
...
<mark style="color:$info;">**Every non-terminated day a boy crossed a girl off the list**</mark>**.**
...
<mark style="color:$warning;">**Improvement Lemma**</mark>: **It just gets better every day for girls**.

Which means that: If on day $$t$$, a girl $$g$$ has a boy $$b$$ on a string, any boy, $$b^′$$, on $$g$$'s string for any day $$t^′> t$$ is at least as good as b.
...
<mark style="color:$danger;">Proof Idea:</mark> <mark style="color:$danger;"></mark><mark style="color:$danger;">**Because she can always keep the previous boy on the string, and she can choose a new boy if she prefer him better**</mark><mark style="color:$danger;">.</mark>
...
* **Induction:**
  ...
  * On day $$t + k + 1$$, boy $$b^′$$ comes back. (means that $$b^′$$ is on $$g$$'s string)
  * Girl can choose $$b^′$$, or do better with another boy, $$b^{′′}$$.&#x20;
    * That is, $$b^′≤b$$ <mark style="color:$danger;">by induction hypothesis (</mark> $$P(k)$$: $$b^′$$ is at least as good as $$b$$ <mark style="color:$danger;">)</mark>.&#x20;
    * And $$b^{′′}$$ is better than $$b^′$$ <mark style="color:$danger;">**by algorithm (if**</mark> $$b^{′′}$$ is choosed, then  $$b^{′′}$$ must be better than  $$b^′$$, becuase <mark style="color:$danger;">**she crosses out only boys who are worse)**</mark>.⇒ Girl does at least as well as with $$b$$ .
  * $$P(k)  ⇒ P(k + 1)$$ by principle of induction.
...
* Every girl has been proposed by b, and Improvement lemma ⇒ each girl has a boy on a string. and each boy is on at most one string.
* n girls and n boys. Same number of each. <mark style="color:$danger;">⇒ b must be on some girl’s string!</mark>
...
* Assume there is a rogue couple: (b, g∗) (b like g\* more than g, and <mark style="color:$danger;">g\* likes b more than b\*</mark>)

<figure><img src=".gitbook/assets/image (19).png" alt=""><figcaption></figcaption></figure>

* Boy b must have proposed to g∗ before proposing to g. So g∗ rejected b (since he moved on)
* By improvement lemma, <mark style="color:$danger;">g∗ likes b∗ better than b</mark>. <mark style="color:$danger;">**Contradiction**</mark><mark style="color:$danger;">!</mark>
...
* **GOAL: To prove that S is unstable.**

Let $$t$$ <mark style="color:$danger;">be first day</mark> a boy $$b$$ gets rejected (**Well ordering priciple** to look on day $$t$$) by his optimal girl $$g$$ in $$T$$, who he is paired with in stable pairing $$S$$.

* $$b^′$$ knocks $$b$$ off of $$g$$’s string on day $$t$$ ⇒ $$g$$ <mark style="color:red;">prefers</mark> $$b^′$$ <mark style="color:red;">to</mark> $$b$$.
* By choice of day $$t$$, $$b^′$$ prefers $$g$$ to his optimal girl. (<mark style="color:$danger;">By well ordering principle,</mark> $$b^′$$ <mark style="color:$danger;">has not been rejected by his optimal girl yet, because he MUST propose as his preference list</mark>) <mark style="color:$danger;">⇒</mark> $$b^′$$ <mark style="color:red;">prefers</mark> $$g$$ <mark style="color:red;">to his partner</mark> $$g^′$$ <mark style="color:red;">in</mark> $$S$$<mark style="color:$danger;">. (Because every boy have a prefer list, if he ask</mark> $$g$$ <mark style="color:$danger;">before</mark> $$g^′$$, then $$b^′$$ must prefer $$g$$ to $$g^′$$<mark style="color:$danger;">)</mark>
...
* $$S$$ – worse <mark style="color:$danger;">stable pairing</mark> for girl $$g$$.

In $$T$$, $$(g, b)$$ is pair.

In $$S$$, $$(g, b^′)$$ is pair.

$$(g, b^′)$$ <mark style="color:orange;">is Rogue couple for</mark> $$S$$:&#x20;

* $$g$$ <mark style="color:red;">likes</mark> $$b^′$$ <mark style="color:red;">less than she likes</mark> $$b$$<mark style="color:red;">, because</mark> $$S$$ <mark style="color:red;">is worse than</mark> $$T$$ <mark style="color:red;">for</mark> $$g$$ ⇒ $$g$$ like $$b$$ than $$b^′$$ in $$S$$
* $$b$$ <mark style="color:red;">likes</mark> $$g$$ <mark style="color:red;">more than his partner</mark> $$g^{′′}$$ <mark style="color:red;">in</mark> $$S$$, because $$T$$ is boy optimal<mark style="color:$info;">.</mark>

<mark style="color:$danger;">**S is not stabl**</mark><mark style="color:$danger;">e. Then there is no worse pairing for girl, it means that T is girl-pessimal.</mark>
