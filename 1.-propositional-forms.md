...
4. P is sufficient for Q: Proving P (P is True) allows you to conclude that Q is true.
5. Q is necessary for P: P to be true it is necessary that Q is true. Or if Q is false then we know that P is false.
6. Q unless not P: means Q is true except when "not P" is true, i.e., except when P is false.
