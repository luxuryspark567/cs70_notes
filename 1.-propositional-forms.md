...
<figure><img src=".gitbook/assets/image (2) (1) (1) (1) (1) (1) (1) (1).png" alt="" width="248"><figcaption></figcaption></figure>
...
* "P implies Q": If P is T, then Q must be T:&#x20;
...
Here are some of the different ways of saying it: ($$P \implies Q$$ is $$T$$)

1. <mark style="color:green;">if</mark> $$P$$<mark style="color:green;">, then</mark> $$Q$$;
2. $$Q$$ <mark style="color:green;">if</mark> $$P$$;
3. $$P$$ <mark style="color:green;">only if</mark> $$Q$$: $$P$$ can be true only if $$Q$$ is true（P只有当Q为T的时候，P才可能为T）. since if Q is false P must be false.
4. $$P$$ <mark style="color:green;">is sufficient for</mark> $$Q$$: Proving P (P is True) allows you to conclude that Q is true.
5. $$Q$$ <mark style="color:green;">is necessary for</mark> $$P$$: For P to be true it is necessary that Q is true. Or if Q is false then we know that P is false.
6. $$Q$$ <mark style="color:green;">unless not</mark> $$P$$:&#x20;
   ...
   3. unless means if not，Q if not not P is Q if Q。Q must be true，unless P is false。
...
* In English: “There is a natural number that is the square of every natural number”.
  * (∃y ∈N) (∀x ∈N) (y = x^2) <mark style="color:$danger;">False</mark>
* In English: “The square of every natural number is a natural number.”
  * (∀x ∈N)(∃y ∈N) (y = x^2) <mark style="color:$success;">True</mark>
...
**Test 1:** $$¬∃x ∀y P(x, y) ⇒ ¬Q(x, y)$$ and $$∀x (∃y P(x, y)) ∧ (∃y Q(x, y))$$

<mark style="color:$danger;">Not equivalent.</mark>

Justification: Using De Morgan’s Law to distribute the negation on the left side yields

$$∀x ∃y \lnot (\lnot P(x, y) \lor \lnot Q(x, y))$$.
...
**Test 2:** $$∀x ∃y P(x) ⇒Q(x, y)$$  and $$∀x P(x) ⇒(∃y Q(x, y))$$

<mark style="color:$success;">Equivalent.</mark>
...
<figure><img src=".gitbook/assets/image (5) (1).png" alt="" width="234"><figcaption></figcaption></figure>
...
* $$\lnot (\exists x P(x))  \equiv \forall x \lnot P(x)$$
  * (There exists an x, P(x) is true) does not hold, means that
...
* Proposition is simply **a statement which is either&#x20;**<mark style="color:green;">**true**</mark>**&#x20;or&#x20;**<mark style="color:red;">**false**</mark>.
  * “3 is odd"
* _<mark style="color:red;">**Propositional forms**</mark>_ <mark style="color:red;"></mark><mark style="color:red;">are statements</mark> <mark style="color:red;"></mark><mark style="color:red;">**with variables**</mark>.
  * P∧Q
* Predicate: Statement with free variables (<mark style="color:red;">Statements about boolean valued functions</mark>).
* Quantifiers: Used to bound predicates.
* Proposition = Quantifier + Predicate. Propositions should <mark style="color:red;">have an underlying “universe"</mark> and the statements are then <mark style="color:red;">quantified over that universe</mark>.&#x20;
  * For all natural numbers $$n$$, $$\sum_{i=1} ^n i = \frac {n(n+1)}{2}$$.

只有定义了Quantifier，我们才知道Predicate是True还是False。
