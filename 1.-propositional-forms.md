...
The first statement says that there is an x, say x′where for every y, P(x, y) is true. Thus,

one can choose x = x′for the second statement and that statement will be true again for every
