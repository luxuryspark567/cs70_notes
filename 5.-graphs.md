...
* <mark style="color:$info;">**Cycle:**</mark> <mark style="color:blue;">Path</mark> with $$v_1 = v_k$$ (So there is no repeated vertex)
  * Length of cycle: $$k−1$$ vertices and edges.
* <mark style="color:$info;">**Walk**</mark> is sequence of edges <mark style="color:$warning;">with possible repeated vertex or edge</mark>.(Might have repeated vertex)
* <mark style="color:$info;">**Tour**</mark> is **walk** that <mark style="color:$warning;">starts and ends at the same node</mark>. (Might have repeated vertex)
...
<div data-full-width="true"><figure><img src=".gitbook/assets/image (1) (1) (1) (1).png" alt="" width="375"><figcaption></figcaption></figure></div>
...
<mark style="color:$info;">**An Eulerian Tour**</mark> <mark style="color:$info;"></mark><mark style="color:$info;">is a tour that visits</mark> <mark style="color:$danger;">each edge</mark> <mark style="color:$info;">exactly once. (visit all verteces??)</mark>
...
<mark style="color:$danger;">5. Splice together.</mark>
...
Let vi be first vertex of $$C$$ that is in $$G_i$$.
...
<mark style="color:$danger;">⇒</mark> $$3f ≤2e$$ <mark style="color:$danger;">for any planar graph. Or</mark> $$f ≤ \frac {2} {3} e$$<mark style="color:$danger;">.</mark>
